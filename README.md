...
[![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Three-taile-dragon/iCopy-Heroku/blob/master/iCopy.ipynb) 
 
## Deployment to Heroku
iCopy Version - v0.2.2 (No Web DashBoard Only Bot)
 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/Three-taile-dragon/iCopy-Heroku/tree/master)

iCopy Version - v0.2.2 (Only Web DashBoard)(NOT SUPPORT)
 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/Three-taile-dragon/iCopy-Heroku/tree/web)
